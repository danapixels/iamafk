...
needsUpdate = true;
console.log(`🔄 Restoring totalAFKTime for ${user.username: ${originalStats.totalAFKTimes`);
...
needsUpdate = true;
console.log(`🔄 Restoring afkBalance for ${user.username: ${originalStats.afkBalances`);
